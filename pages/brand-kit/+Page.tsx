    ...
    <section>
      ...
      <div className="stack" style={{ maxWidth: 980 }}>
        <div className="panel" data-reveal="up">
          ...
          <div className="gridAuto gridAuto280">
            <div className="panelInset" data-reveal="up" data-reveal-delay="80" data-reveal-variant="fast">
            ...
            <div className="panelInset" data-reveal="up" data-reveal-delay="160" data-reveal-variant="fast">
